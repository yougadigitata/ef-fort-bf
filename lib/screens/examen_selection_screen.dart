          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text(
                  '10 concours × 4 séries · 50 questions · 1h30',
                  style: TextStyle(
                    fontSize: 15,
                    color: Colors.white.withValues(alpha: 0.75),
                    fontWeight: FontWeight.w500,
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              '30 examens types officiels + Examens Blancs · Interface vraie feuille\n50 questions · 1h30 · Correction détaillée',
              textAlign: TextAlign.center,
              style: TextStyle(
                fontSize: 16,
            ...
            Text(
              '10 concours × Série 1, Série 2, Série 3, Examens Blancs = 40 examens types',
              textAlign: TextAlign.center,
              style: TextStyle(
                fontSize: 14,
